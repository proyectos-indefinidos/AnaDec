...
#periodo_actual: es la temporalidad en la que se encuentra la tasa (puede ser 1(mes), 3(trimestre), 6(semestre), 12(año))
#
#nuevo_periodo:
    def cambiarTemporalidadEnEfectivo(self, tasa, periodo_actual, nuevo_periodo):
...
#se quiere cambiar a una frecuencia mayor o menor de la que se tiene
    ...
    def cambiarTemporalidadEnNominal(self, tasa):
        pass
...
if __name__ == "__main__":
    ...
    print(convertidor.cambiarTemporalidadEnEfectivo(0.06, 3, 12))  # Ejemplo de uso, se puede revisar en las diapos, que voy a adjuntar, esta correcto!